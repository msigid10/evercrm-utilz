...
export default function() {
  describe('Send Message: Success', () => { 
    ...
    const accessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEwMDAwMjg0NDQwNiwicm9sZUlkIjoxLCJyb2xlTmFtZSI6ImFkbWluIiwidGVhbUlkIjpudWxsLCJ0ZWFtTWVtYmVyc2hpcElkIjpudWxsLCJ0ZWFtT3duZXJJZCI6bnVsbCwibWVyY2hhbnRDb2RlIjoiZXZlcnBybyIsImlzcyI6IkV2ZXJDUk0iLCJleHAiOjE3MTc3MjczODQsImlhdCI6MTcxNzQ2ODE4NH0.vY8M88Z3eSEPBImXG7eQe8-1Eni99GbPHHdszeEmQF8'
    // const deviceKey = 'Rb4nv_rVg'
    const deviceKey1 = 'vLgxw3iIR'
    ...
    //tanpa image
    const response1 = step_everwhatsapp.message.sendMessage(accessToken, SEND_MESSAGE_DATA.content, deviceKey1, SEND_MESSAGE_DATA.destinationNumber, SEND_MESSAGE_DATA.contentImageURL)
