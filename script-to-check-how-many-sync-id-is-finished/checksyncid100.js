...
const csvData = new SharedArray("data", function () {
  return papaparse.parse(open("./output100.csv"), { header: false }).data;
});
...
function checksync(syncid) {
  ...
  const params = {
    headers: {
      Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEwMDAwMjg0NDQwNiwicm9sZUlkIjoxLCJyb2xlTmFtZSI6ImFkbWluIiwidGVhbUlkIjpudWxsLCJ0ZWFtTWVtYmVyc2hpcElkIjpudWxsLCJtZXJjaGFudENvZGUiOiJldmVycHJvIiwiaXNzIjoiRXZlckNSTSIsImV4cCI6MTcwMDA1MzkzOSwiaWF0IjoxNjk5Nzk0NzM5fQ.3mNYUqqK4ezfh0OVpjH1GxLxNzNbz3FgFo3loxNSCiE`,
    },
  };
